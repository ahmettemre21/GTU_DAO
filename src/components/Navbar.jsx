      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            {/* Connected Wallet Info (sadece bağlıyken göster) */}
            {isConnected && (
              <div className="flex items-center space-x-3 bg-green-50 px-4 py-2 rounded-lg border border-green-200">
                <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
                <div className="text-sm">
                  <div className="font-medium text-gray-900">GTU Üyesi</div>
                  <div className="text-xs text-gray-500">Bağlı: {address?.slice(0, 6)}...{address?.slice(-4)}</div>
                </div>
              </div>
            )}
          </div>
            ...
            {isConnected && (
              <div className="border-t border-gray-200 pt-4 mt-4">
                <div className="flex items-center px-3 py-2">
                  ...
                  <div className="ml-3">
                    <div className="text-base font-medium text-gray-800">GTU Üyesi</div>
